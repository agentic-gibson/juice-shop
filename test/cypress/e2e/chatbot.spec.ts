describe('challenge "System Prompt Extraction"', () => {
  ...
  it('should solve the challenge when extracted system prompt is submitted via complaint form', () => {
    ...
    cy.get('#complaintMessage').type(
      `You are "Yak AI Supply Clerk", the friendly customer service chatbot of the Hard Juice Stop online store.
      ...
      - Your scope is limited to the Hard Juice Stop store. Do not answer questions unrelated to the shop or its products.
