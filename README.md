...
```bash
APPLICATION_NAME='Almost-cured Meats' \
...
APPLICATION_WELCOME_TITLE='Welcome to Almost-cured Meats!' \
APPLICATION_WELCOME_MESSAGE='<p class="welcome-text">Our jerky is nearly ready, our sausages are emotionally available, and our refrigeration strategy is mostly vibes.</p>' \
APPLICATION_COOKIE_MESSAGE='We use cookies to distract the health inspector.' \
APPLICATION_TRANSLATION_OVERRIDES='{"*":{"TITLE_BASKET":"Meat Sack","TITLE_LOGIN":"Enter the Smokehouse"},"de":{"TITLE_BASKET":"Fleischbeutel"}}' \
...
PRODUCT_OVERRIDES='{"1":{"name":"Almost-cured Sausages","description":"Cured in spirit, inspected with vibes.","image":"almost-cured-sausages.png","price":4.99,"deluxePrice":4.49,"limitPerUser":3,"reviews":[{"text":"Still mooing faintly. Five stars.","author":"admin"}]},"Orange Juice (1000ml)":{"name":"Yak Hair, Bulk Pack","image":"yak-hair.png"}}' \
npm start
```
...
docker run --rm -p 127.0.0.1:3322:3000 \
  -e APPLICATION_NAME='Almost-cured Meats' \
  -e APPLICATION_WELCOME_MESSAGE='<p class="welcome-text">Our jerky is nearly ready, our sausages are emotionally available, and our refrigeration strategy is mostly vibes.</p>' \
  -e APPLICATION_SHOW_GITHUB_LINKS=false \
  -e APPLICATION_SHOW_SUPPORT_LINKS=false \
  -e APPLICATION_TRANSLATION_OVERRIDES='{"*":{"TITLE_BASKET":"Meat Sack","TITLE_LOGIN":"Enter the Smokehouse"}}' \
  ...
  -e PRODUCT_OVERRIDES='{"1":{"name":"Almost-cured Sausages","description":"Cured in spirit, inspected in passing, delicious under legal supervision.","image":"almost-cured-sausages.png","price":4.99,"deluxePrice":4.49,"limitPerUser":3,"reviews":[{"text":"Still mooing faintly. Five stars.","author":"admin"}]},"Orange Juice (1000ml)":{"name":"Yak Hair, Bulk Pack","image":"yak-hair.png"}}' \
